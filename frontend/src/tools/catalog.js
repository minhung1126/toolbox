...
export const TOOL_MODULES = Object.freeze([
  ...
  },
  {
    ...
    description: 'Instagram 貼文三部曲照片策展工作台，支援主題視角分流、防漏分配池、首圖橫排預覽與一鍵結構化打包。',
    category: '日常生產力',
    icon: Instagram,
    badge: '策展模組',
    status: 'active',
    ...
    navGroups: [
      {
        ...
        icon: Instagram,
        items: [
          { id: 'photo_curator_workbench', to: PATHS.photoCurator, label: 'Instagram 策展', icon: Instagram },
        ],
      },
    ],
    featureCards: [
      {
        ...
        title: 'Instagram 貼文策展',
        description: '將一系列照片依空間、人物、細節分流為 3 篇 IG 貼文，具備防漏計數、序號鎖定與結構化打包。',
